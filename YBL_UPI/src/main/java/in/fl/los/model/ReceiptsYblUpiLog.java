...
@Entity
@Table(name = "receipts_ybl_upi_log", indexes = {
		@Index(name = "receiptsYblUpiLogIdxlReceiptsCamsUpiDebitDate", columnList = "loan_no,status,bank_error,debit_try_count,debit_date"),
		@Index(name = "receiptsYblUpiLogIdxlBankNameMndtExecDescStatus", columnList = "bank_name,mndt_exec_desc,mndt_exec_status"),
		@Index(name = "receiptsYblUpiLogIdxlCpMdtRefNoAndExecTrxnNo", columnList = "cp_mdt_ref_no,exec_trxn_no"),
		@Index(name = "receiptsYblUpiLogIdxlUpiPredebitStatus", columnList = "predebit_date,status"),
		@Index(name = "receiptsYblUpiLogIdxlMndtexecStatusDate", columnList = "mndt_exec_status,status,predebit_date"),
		@Index(name = "receiptsYblUpiLogIdxlReceiptsStatusLoanid", columnList = "loan_id,status"),
		@Index(name = "receiptsYblUpiLogIdxlReceiptsCamsUpiFilter", columnList = "loan_no,status,pre_debit_time"),
		@Index(name = "receiptsYblUpiLogIdxlReceiptsCamsUpiLoan", columnList = "loan_no,status,mndt_exec_status,mndt_exec_time"),
		@Index(name = "receiptsYblUpiLogIdxlDebitDateMndtExecDesc", columnList = "debit_date,mndt_exec_desc"),
		@Index(name = "receiptsYblUpiLogIdxlMndtExecDescStatus", columnList = "mndt_exec_desc,mndt_exec_status"),
		@Index(name = "receiptsYblUpiLogIdxlReceiptsCamsUpi", columnList = "cp_mdt_ref_no,status,predebit_date"),
		@Index(name = "receiptsYblUpiLogIdxlReceiptsCamsUpiPredebitstatus", columnList = "status,predebit_date"),
		@Index(name = "receiptsYblUpiLogIdxlReceiptsCamsUpiBank", columnList = "loan_no,status,bank_error,debit_try_count,mndt_exec_time"),
		@Index(name = "receiptsYblUpiLogIdxlDebitDateMndtExecDescStatus", columnList = "debit_date,mndt_exec_desc,mndt_exec_status"),
		@Index(name = "receiptsYblUpiLogIdxlUpiPredebitBank", columnList = "predebit_date,bank_name"),
		@Index(name = "receiptsYblUpiLogIdxlPredebitMndtexecDate", columnList = "pre_debit_status,mndt_exec_status,predebit_date"),
		@Index(name = "receiptsYblUpiLogIdxlPredebitStatusDate", columnList = "pre_debit_status,status,predebit_date"),
		@Index(name = "receiptsYblUpiLogIdxlMndtexecStatus", columnList = "mndt_exec_status,status"),
		@Index(name = "receiptsYblUpiLogIdxlPredebitMndtexecStatusDate", columnList = "pre_debit_status,mndt_exec_status,status,predebit_date"),
		@Index(name = "receiptsYblUpiLogIdxlPredebitdate", columnList = "loan_no,status,pre_debit_time,predebit_date"),
		@Index(name = "receiptsYblUpiLogIdxlLoannoStatus", columnList = "loan_no,status"),
		@Index(name = "receiptsYblUpiLogIdxlReceiptsCamsUpiMandt", columnList = "status,mndt_exec_status,mndt_exec_time"),
		@Index(name = "receiptsYblUpiLogIdxlRcptLnMndtCustLoan", columnList = "cust_id,loan_id"),
		@Index(name = "receiptsYblUpiLogIdxlUpiPredebitBankStatus", columnList = "predebit_date,bank_name,pre_debit_status"),
		@Index(name = "receiptsYblUpiLogIdxlReceiptsCamsUpiReceivable", columnList = "receivable_id,cp_mdt_ref_no,status"),
		@Index(name = "receiptsYblUpiLogIdxlBankNameMndtExecDesc", columnList = "bank_name,mndt_exec_desc"),
		@Index(name = "receiptsYblUpiLogIdxlPredebitStatus", columnList = "pre_debit_status,status") })
public class ReceiptsYblUpiLog implements Serializable {

	private static final long serialVersionUID = 4302417397102135733L;
	...
	private int id;
	@Column(name = "cams_upi_id", precision = 11)
	private int camsUpiId;
	...
	/**
	 * Access method for camsUpiId.
	 *
	 * @return the current value of camsUpiId
	 */
	public int getCamsUpiId() {
		return camsUpiId;
	}

	/**
	 * Setter method for camsUpiId.
	 *
	 * @param aCamsUpiId the new value for camsUpiId
	 */
	public void setCamsUpiId(int aCamsUpiId) {
		camsUpiId = aCamsUpiId;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(bankError, bankErrorCode, bankName, bankRrn, callback, callbackTime, camsUpiId, cpMdtRefNo,
				createTime, custId, debitDate, debitResponse, debitStatusResponse, debitStatusTrycount, debitTryCount,
				edi, execTrxnNo, executionRefNo, id, loanId, loanNo, mndtExecDesc, mndtExecEndtime, mndtExecStarttime,
				mndtExecStatus, mndtExecTime, mndtExecTimetaken, modifyTime, preDebitDesc, preDebitStatus, preDebitTime,
				predebitDate, predebitResponse, receiptMode, receiptType, receivableId, seqNo, sipTrxnNo, source,
				status, umn);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReceiptsYblUpiLog other = (ReceiptsYblUpiLog) obj;
		return Objects.equals(bankError, other.bankError) && Objects.equals(bankErrorCode, other.bankErrorCode)
				...
				&& camsUpiId == other.camsUpiId && Objects.equals(cpMdtRefNo, other.cpMdtRefNo)
				&& Objects.equals(createTime, other.createTime) && custId == other.custId
				&& Objects.equals(debitDate, other.debitDate) && Objects.equals(debitResponse, other.debitResponse)
				...
				&& id == other.id && loanId == other.loanId && Objects.equals(loanNo, other.loanNo)
				&& Objects.equals(mndtExecDesc, other.mndtExecDesc)
				...
				&& Objects.equals(predebitResponse, other.predebitResponse)
				...
				&& Objects.equals(sipTrxnNo, other.sipTrxnNo) && Objects.equals(source, other.source)
				&& Objects.equals(status, other.status) && Objects.equals(umn, other.umn);
	}

	@Override
	public String toString() {
		return String.format(
				"ReceiptsYblUpiLog [id=%s, camsUpiId=%s, loanId=%s, loanNo=%s, custId=%s, bankName=%s, cpMdtRefNo=%s, edi=%s, predebitDate=%s, debitDate=%s, preDebitTime=%s, seqNo=%s, receivableId=%s, preDebitStatus=%s, preDebitDesc=%s, predebitResponse=%s, execTrxnNo=%s, mndtExecTime=%s, mndtExecTimetaken=%s, mndtExecStarttime=%s, mndtExecEndtime=%s, mndtExecStatus=%s, mndtExecDesc=%s, executionRefNo=%s, bankRrn=%s, sipTrxnNo=%s, umn=%s, debitTryCount=%s, callback=%s, callbackTime=%s, debitResponse=%s, debitStatusResponse=%s, debitStatusTrycount=%s, bankError=%s, bankErrorCode=%s, receiptMode=%s, receiptType=%s, source=%s, status=%s, createTime=%s, modifyTime=%s, getClass()=%s, toString()=%s]",
				id, camsUpiId, loanId, loanNo, custId, bankName, cpMdtRefNo, edi, predebitDate, debitDate, preDebitTime,
				seqNo, receivableId, preDebitStatus, preDebitDesc, predebitResponse, execTrxnNo, mndtExecTime,
				mndtExecTimetaken, mndtExecStarttime, mndtExecEndtime, mndtExecStatus, mndtExecDesc, executionRefNo,
				bankRrn, sipTrxnNo, umn, debitTryCount, callback, callbackTime, debitResponse, debitStatusResponse,
				debitStatusTrycount, bankError, bankErrorCode, receiptMode, receiptType, source, status, createTime,
